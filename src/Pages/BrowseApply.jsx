...
function BrowseApply() {
  ...
  const canApplyToJob = (job) => {
    ...
    const userFields = Array.isArray(user.jobField)
      ? user.jobField
      : [user.jobField];
  ...
  if (!user) {
    return (
      <div className="page-container">
        ...
        <p className="intro-text">
          Explore thousands of jobs tailored to your professional skills and
          experience levels.
        </p>
  ...
  return (
    <div className="page-container">
      ...
      {applicationMessage && (
        <div
          className={
            applicationType === "success" ? "success-message" : "error-message"
          }
        >
          {applicationMessage}
        </div>
      ...
      <section className="discovery-section">
        {loading ? (
          ...
          >
            ...
            <h3 style={{ marginBottom: "8px" }}>No jobs found</h3>
            <p style={{ color: "var(--text-secondary)" }}>
              Check back later for new opportunities in your field.
            </p>
          </div>
        ) : (
          <div className="content-section">
