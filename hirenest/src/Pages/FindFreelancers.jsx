...
function FindFreelancers() {
  ...
  const filteredSeekers =
    selectedField === "All"
      ? jobSeekers
      : jobSeekers.filter(
          (s) => s.jobField && s.jobField.includes(selectedField),
        );
      ...
      {!canChat && (
        ...
        >
          <p style={{ margin: 0, fontSize: "1.1rem" }}>
            💡 Only job providers can chat with freelancers. Sign up as a job
            provider to connect with talent.
          </p>
        </div>
      )}
      ...
      <div className="content-section">
        ...
        {loading ? (
          ...
          >
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              Check back later for new talent in your field.
            </p>
          </div>
        ) : (
              ...
              >
                ...
                >
                  {seeker.profilePicture ? (
                    ...
                    >
                      ...
                      {seeker.lastName?.charAt(0)}
                    </div>
                  )}
                  <div style={{ marginLeft: "16px" }}>
                    <h3 style={{ margin: "0 0 4px 0", fontSize: "1.25rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "2px" }}>
                      {[1, 2, 3, 4, 5].map((star) => (
                        <span
                          ...
                          style={{
                            color:
                              star <= Math.round(seeker.averageRating)
                                ? "#f59e0b"
                                : "#d1d5db",
                            fontSize: "18px",
                          }}
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  >
                    ...
                    {seeker.jobsCompleted || 0}
                  </p>
                </div>

                {seeker.certificationImages &&
                  seeker.certificationImages.length > 0 && (
                    <div style={{ marginBottom: "20px" }}>
                      <p
                        style={{
                          margin: "0 0 12px 0",
