  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        throw new Error(
          data.error || data.failedreason || "Failed to initialize payment",
        );
      }
  ...
  return (
    <div className="page-container">
      ...
      <p className="intro-text">
        Find the perfect talent for your project. Define your requirements and
        receive proposals from qualified professionals.
      </p>
          ...
          <div className="post-job-header">
            ...
            <div>
              ...
              <p className="post-job-subtitle">
                Fill in the details to find the best talent
              </p>
            </div>
          </div>
                ...
                <div className="dashboard-job-header">
                  <div className="dashboard-job-info">
                    ...
                    <p className="dashboard-job-meta">
                      <span>Field:</span> {job.jobField} |<span>Budget:</span>{" "}
                      {job.budget}
                    </p>
                    <p className="dashboard-job-meta">
                      <span>Status:</span>{" "}
