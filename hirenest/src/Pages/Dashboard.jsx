      ...
      <div className="dashboard-header">
        <div>
          ...
          <p className="intro-text">
            ...
            {user.role === "jobProvider" ? "job postings" : "applications"}{" "}
            overview.
          </p>
        </div>
      </div>
        ...
        {user.role === "jobProvider" ? (
          <>
            ...
            <div className="stat-card">
              ...
              <div className="stat-content">
                <span className="stat-number">
                  {myJobs.reduce((acc, j) => acc + j.applicants.length, 0)}
                </span>
          ...
          <>
            ...
            <div className="stat-card">
              ...
              <div className="stat-content">
                <span className="stat-number">
                  {myApplications.filter((j) => j.status === "open").length}
                </span>
                          ...
                          {job.applicants.map((applicant, idx) => (
                            <div key={idx} className="applicant-item">
                              ...
                              <div className="applicant-details">
                                ...
                                <p className="applicant-field">
                                  {applicant.user?.jobField}
                                </p>
                                {applicant.proposal && (
                                  <p className="applicant-proposal">
                                    {applicant.proposal}
                                  </p>
                                )}
                              </div>
              ...
              {myApplications.map((job) => {
                const myApplication = job.applicants?.find(
                  (app) =>
                    app.user &&
                    app.user._id &&
                    String(app.user._id) === String(user._id),
                );
                        ...
                        >
                          ...
                          >
                            ...
                            {job.status === "completed"
                              ? "Job Completed!"
                              : "Job Closed!"}{" "}
                            Thanks for working with {job.postedBy?.firstName}{" "}
        ...
        >
          ...
          >
            ...
            <p style={{ color: "var(--text-secondary)", marginBottom: "24px" }}>
              This job has an accepted applicant. Would you like to rate them
              before closing?
            </p>
